---
title: "Hakai Institute Juvenile Salmon Program Data Contributing Guidelines"
date: "April 9, 2018"
...
The top row of each column should be a header, and follow an unambiguous naming scheme, e.g. `age_class` instead of `AC`. Do not use spaces in column header names (underscores are preferred), and avoid capitalization at all costs.
