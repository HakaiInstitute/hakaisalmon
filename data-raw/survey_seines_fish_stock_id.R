...
survey_seines_fish_stock_id <- left_join(survey_seines_fish, stock_id,
                                         by = c("ufn", "semsp_id"))

write_csv(survey_seines_fish_stock_id, "data-raw/survey_seines_fish_stock_id.csv")
devtools::use_data(survey_seines_fish_stock_id, overwrite = TRUE)
